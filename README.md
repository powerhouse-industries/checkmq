...
If you're using Bower to manage your front-end dependencies you can include this plugin as a component. Include "checkmq": "1.0.2" in your bower.json file and run bower install.
